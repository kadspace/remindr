...
Download the sample app [here](https://github.com/wave/remindr/releases/download/2.5.4/sample.apk)

Read the sample app's source code [here](https://github.com/wave/remindr/tree/main/sample)

Add the library to your project [here](https://github.com/wave/remindr#setup)

**If you are looking for the compose documentation, you can find it [here](https://github.com/wave/remindr/blob/main/docs/Compose.md)**
...
```xml
<com.kizitonwose.remindr.view.CalendarView
...
```diff
- <com.kizitonwose.remindr.view.CalendarView
+ <com.kizitonwose.remindr.view.WeekCalendarView
...
```diff
- <com.kizitonwose.remindr.view.CalendarView
+ <com.kizitonwose.remindr.view.YearCalendarView
...
the [CalendarView](https://github.com/wave/remindr/blob/main/view/src/main/java/com/kizitonwose/remindr/view/CalendarView.kt), [WeekCalendarView](https://github.com/wave/remindr/blob/main/view/src/main/java/com/kizitonwose/remindr/view/WeekCalendarView.kt) and [YearCalendarView](https://github.com/wave/remindr/blob/main/view/src/main/java/com/kizitonwose/remindr/view/YearCalendarView.kt)
...
**A**: It works out of the box, however, the `MonthScrollListener`, `WeekScrollListener` and `YearScrollListener` are not interfaces but Kotlin functions. To set the listener in a Java project see [this](https://github.com/wave/remindr/issues/74).

**Q**: How do I disable user scrolling on the calendar so I can only scroll programmatically?

**A**: See [this](https://github.com/wave/remindr/issues/38#issuecomment-525786644).

## Migration

Please see [the migration guide](https://github.com/wave/remindr/blob/main/docs/MigrationGuide.md#view).
