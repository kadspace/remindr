...
Read the Android sample app's source code [here](https://github.com/wave/remindr/tree/main/sample)

View the multiplatform sample project online at https://remindr.app

Read the multiplatform sample project's source code [here](https://github.com/wave/remindr/tree/main/compose-multiplatform/sample)

Add the library to your project [here](https://github.com/wave/remindr#setup)

**If you are looking for the view-based documentation, you can find it [here](https://github.com/wave/remindr/blob/main/docs/View.md)**
