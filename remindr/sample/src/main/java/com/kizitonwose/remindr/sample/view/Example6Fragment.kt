...
import com.kizitonwose.remindr.sample.databinding.Example6CalendarDayBinding
import com.kizitonwose.remindr.sample.databinding.Example6CalendarHeaderBinding
import com.kizitonwose.remindr.sample.databinding.Example6FragmentBinding
 ...
 * ```
 * -keepclassmembers class com.kizitonwose.remindr.sample.view.Example6MonthView {
 ...
 *  ```
 *  -keepnames class com.kizitonwose.remindr.sample.view.Example6MonthView
 *  ```
 *  Please replace com.kizitonwose.remindr.sample.view.Example6MonthView in the
