package com.kizitonwose.remindr.core.serializers

import com.kizitonwose.remindr.core.Year
import com.kizitonwose.remindr.core.format.fromIso8601Year
...
public object YearIso8601Serializer : KSerializer<Year> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("com.kizitonwose.remindr.core.Year", PrimitiveKind.STRING)
...
public object YearComponentSerializer : KSerializer<Year> {
    override val descriptor: SerialDescriptor =
        buildClassSerialDescriptor("com.kizitonwose.remindr.core.Year") {
            element<Int>("year")
        }
