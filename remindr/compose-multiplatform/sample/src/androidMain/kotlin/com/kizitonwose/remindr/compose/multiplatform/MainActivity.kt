package com.kizitonwose.remindr.compose.multiplatform

import App
import com.kizitonwose.remindr.compose.multiplatform.sample.DatabaseDriverFactory
import com.kizitonwose.remindr.compose.multiplatform.sample.AndroidReminderScheduler
...
class MainActivity : ComponentActivity() {
    ...
    private fun sendRichNotification(log: (String) -> Unit) {
        ...
        val snoozeIntent = android.content.Intent(this, com.kizitonwose.remindr.compose.multiplatform.sample.NotificationActionReceiver::class.java).apply {
        ...
        val doneIntent = android.content.Intent(this, com.kizitonwose.remindr.compose.multiplatform.sample.NotificationActionReceiver::class.java).apply {
            action = "ACTION_DONE"
            putExtra("NOTE_ID", 2)
        }
        ...
        val deleteIntent = android.content.Intent(this, com.kizitonwose.remindr.compose.multiplatform.sample.NotificationActionReceiver::class.java).apply {
